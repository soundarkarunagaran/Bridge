        ...
        statics: {
            methods: {
                ...
                AssertNumber: function (expected, actual, message) {
                    if (message === void 0) { message = null; }
                    Bridge.Test.NUnit.Assert.AreEqual(Bridge.Reflection.getTypeName(System.Object), Bridge.Reflection.getTypeName(System.Object), (message || "") + " type");
                ...
                AssertDouble$1: function (expected, actual, message) {
                    if (message === void 0) { message = null; }
                    Bridge.Test.NUnit.Assert.AreEqual("Double", Bridge.Reflection.getTypeName(Bridge.getType(actual, System.Double)), (message || "") + " type");
                ...
                AssertDoubleTryParse: function (r, expected, s, message) {
                    ...
                    Bridge.Test.NUnit.Assert.AreEqual("Double", Bridge.Reflection.getTypeName(Bridge.getType(actual.v, System.Double)), (message || "") + " type");
                ...
                AssertFloat: function (expected, actual, message) {
                    if (message === void 0) { message = null; }
                    Bridge.Test.NUnit.Assert.AreEqual("Single", Bridge.Reflection.getTypeName(Bridge.getType(actual, System.Single)), (message || "") + " type");
                ...
                AssertDecimal$1: function (expected, actual, message) {
                    if (message === void 0) { message = null; }
                    Bridge.Test.NUnit.Assert.AreEqual("Decimal", Bridge.Reflection.getTypeName(System.Object), (message || "") + " type");
                    Bridge.Test.NUnit.Assert.AreEqual(Bridge.toString(expected), Bridge.toString(actual), (message || "") + " representation");
                },
                AssertDecimal$2: function (expected, actual, message) {
                    if (message === void 0) { message = null; }
                    Bridge.Test.NUnit.Assert.AreEqual("Decimal", Bridge.Reflection.getTypeName(Bridge.getType(actual, System.Decimal)), (message || "") + " type");
                ...
                AssertLong: function (expected, actual, message) {
                    ...
                    Bridge.Test.NUnit.Assert.AreEqual("System.Int64", Bridge.Reflection.getTypeFullName(System.Object), (message || "") + " type");
                    Bridge.Test.NUnit.Assert.AreEqual(Bridge.toString(expected), Bridge.toString(actual), message);
                },
                AssertULong: function (expected, actual, message) {
                    if (message === void 0) { message = ""; }
                    Bridge.Test.NUnit.Assert.AreEqual("System.UInt64", Bridge.Reflection.getTypeFullName(System.Object), (message || "") + " type");
                    Bridge.Test.NUnit.Assert.AreEqual(Bridge.toString(expected), Bridge.toString(actual), message);
                }
            }
        }
