...
namespace Bridge.Translator
{
    public partial class Translator
    {
        public virtual void BuildAssembly()
        {
            ...
            var parseOptions = new CSharpParseOptions(LanguageVersion.CSharp7, Microsoft.CodeAnalysis.DocumentationMode.Parse, SourceCodeKind.Regular, AssemblyInfo.DefineConstants);
