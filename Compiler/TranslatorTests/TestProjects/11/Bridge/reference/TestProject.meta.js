Bridge.assembly("TestProject", function ($asm, globals) {
    ...
    var $m = Bridge.setMetadata,
        $n = [System,TestProject1,TestProject2,Issue3278,N3208_1_AndreyReview1,Issue2493];
    ...
    $m($n[3].Program, function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"TestProp","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_TestProp","t":8,"rt":$n[0].String,"fg":"TestProp"},"fn":"TestProp"}]}; });
    ...
    $m($n[5].Operation3, function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Add","t":8,"pi":[{"n":"a","pt":$n[0].Int32,"ps":0},{"n":"b","pt":$n[0].Int32,"ps":1}],"sn":"Add","rt":$n[0].Int32,"p":[$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Int32);}}]}; });
});
