        ...
        statics: {
            methods: {
                ...
                GetArgumentName: function (argument) {
                    ...
                    return System.Enum.toStringFn(Bridge.getType(argument, System.ExceptionArgument))(argument);
                },
                GetResourceString: function (resource) {

                    return System.SR.GetResourceString(System.Enum.toStringFn(Bridge.getType(resource, System.ExceptionResource))(resource));
                },
