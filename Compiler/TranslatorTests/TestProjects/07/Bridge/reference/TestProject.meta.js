Bridge.assembly("TestProject", function ($asm, globals) {
    ...
    var $m = Bridge.setMetadata,
        $n = [System,TestProject.Issues,TestProject.Issues.N2217,TestProject1,TestProject2];
