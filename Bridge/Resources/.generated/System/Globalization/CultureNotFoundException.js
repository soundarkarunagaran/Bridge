    Bridge.define("System.Globalization.CultureNotFoundException", {
        ...
        props: {
            ...
            FormatedInvalidCultureId: {
                get: function () {
                    var $t;
                    return this.InvalidCultureId != null ? System.String.formatProvider(System.Globalization.CultureInfo.invariantCulture, "{0} (0x{0:x4})", [Bridge.box(($t = this.InvalidCultureId, Bridge.cast($t, Bridge.hasValue($t) && (System.Nullable.getValue($t)))), System.Int32)]) : this.InvalidCultureName;
                }
            },
            Message: {
                get: function () {
